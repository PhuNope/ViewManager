...
namespace Nope.ViewManager.Runtime.ScriptableObjects {
    using System;
    using UnityEngine;
    ...
    public class LayerRecord {
        ...
        [SerializeField] private AdditionalCanvasShaderChannels additionalShaderChannels;
        ...
        public AdditionalCanvasShaderChannels AdditionalShaderChannels {
            get { return additionalShaderChannels; }
        }

        public bool HasName {
            get => !string.IsNullOrEmpty(LayerName);
        }
    }
}